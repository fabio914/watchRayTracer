...
- (void)viewDidAppear:(BOOL)animated {
    ...
    RTScene * scene = [RTScene sceneWithCamera:[RTCamera cameraWithEye:[RTPoint pointWithX:-5.0 Y:8.0 Z:5.0]
...
- (void)render:(RTScene *)scene {
    ...
    UIImage * result = [[RTRayTracer rayTraceScene:scene dimension:[RTDimension dimensionWithSize:self.imageView.frame.size]] image];
